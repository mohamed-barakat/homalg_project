        ...
        rec(
               ...
               CopyMatrix :=
                 function( C, R )
                   ...
                   homalgSendBlocking( [ v, "map = AlgebraHomomorphism(", S, R, ", [", map, "])" ], "need_command", "break_lists", "define" );
               ...
               Coefficients :=
                 function( poly, var )
                   ...
                   coeffs := homalgSendBlocking( [ "collect(coeffs(", poly, "))" ], "Coefficients" );
               ...
               CoefficientsWithGivenMonomials :=
                 function( M, monomials )
                   ...
                   return homalgSendBlocking( [ "coeffs(", M, ", ", monomials, ")" ], "Coefficients" );
               ...
               CoefficientsOfUnivariatePolynomial :=
                 function( r, var )
                   ...
                   return homalgSendBlocking( [ "coeffs( ", r, var, " )" ], "Coefficients" );
               ...
               Pullback :=
                 function( phi, M )
                   ...
                   if not IsBound( phi!.RingMap ) then
                       phi!.RingMap :=
                         homalgSendBlocking( [ "AlgebraHomomorphism(", Source( phi ), Range( phi ), ", [", ImagesOfRingMap( phi ), "])" ], "break_lists", "define" );
                   fi;
